...
const initialDBData = [
  ...
  { id: '4', name: 'rubab riaz', email: 'ummerubab2024168@gmail.com', subject: 'mern stack', status: 'Pending', created_at: '2026-07-17T23:10:00Z' },
  { id: '5', name: 'babar azam', email: 'ummerubab2024168@gmail.com', subject: 'mern stack', status: 'Done', created_at: '2026-07-17T23:05:00Z' },
];
  ...
  async function fetchQueries() {
    ...
    try {
      ...
      if (!error && data && data.length > 0) {
        // Merge Supabase live data with initial data (avoiding duplicates)
        const combined = [...data];
        initialDBData.forEach(item => {
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0f172a', color: 'white', fontFamily: 'sans-serif' }}>
      ...
      <main style={{ flex: 1, padding: '2.5rem' }}>
        ...
        <div style={{ backgroundColor: '#1e293b', borderRadius: '12px', border: '1px solid #334155', overflow: 'hidden' }}>
          {loading ? (
            <p style={{ padding: '2rem', textAlign: 'center', color: '#94a3b8' }}>Loading queries...</p>
